...
export function createRecordKey(name, time, namespace = '') {
  const coreKey = `${createSlug(name)}::${normalizeTime(time).toLowerCase()}`;
  return namespace ? `${namespace}::${coreKey}` : coreKey;
}
