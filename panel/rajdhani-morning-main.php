...
<html amp="" lang="en-in">
 <head>
  ...
  <title>
   RAJDHANI MORNING MAIN PANEL CHART RECORD MATKA BAZAR
  </title>
  <meta content="RAJDHANI MORNING [main] PANEL CHART RECORD PATTI PANNA BAZAR 
...
FIX NUMBER RAJDHANI MORNING [main] MATKA RECORD CHART BOOK" name="description"/>
  <meta content="IE=edge" http-equiv="X-UA-Compatible"/>
  <meta content="width=device-width, initial-scale=1" name="viewport"/>
  <link href="assets/panel-chart-record/rajdhani-morning-main.php" rel="canonical"/>
    ...
    <div class="panel panel-info">
     <div class="panel-heading text-center" style="background: #3f51b5;">
      <h1 style="font-size: 22px;color:#fff; text-shadow: 0px 0px;">
       RAJDHANI MORNING [main] PANEL CHART
      </h1>
     </div>
