...
writing-mode: vertical-rl;
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p>
    DPBoss Services takes pride in offering an extensive archive of CB Panel Chart Records, meticulously crafted to cater to the needs of seasoned players and novices alike. The CB Panel Chart Records present a detailed visual representation of Matka results, featuring charts, patterns, and historical data. This resource serves as a valuable compass for enthusiasts, allowing them to navigate the complexities of Matka gaming with confidence and precision.
   </p>
   <br/>
