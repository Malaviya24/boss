...
writing-mode: vertical-rl;
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   <p>
    Welcome to DPBoss Services, your one-stop destination for accurate and reliable RATNA DAY Panel Chart Records. We take pride in providing comprehensive and up-to-date charts that cater to the diverse needs of our users. Our RATNA DAY Panel Chart Records are meticulously curated, ensuring precision and authenticity for a seamless gaming experience.
   </p>
   <br/>
   <div class="small-heading">
    Key Features of DPBoss Services - RATNA DAY Panel Chart Records:
   </div>
   <p>
    <b>
