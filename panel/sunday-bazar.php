...
writing-mode: vertical-rl;
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1: How frequently are the Sunday Bazar Panel Chart Records updated on DPBoss Services?
   </p>
   <p class="faq-ans">
