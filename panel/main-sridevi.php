   ...
   <div>
    ...
    <div class="para3">
     ...
     <p style="margin: 0;font-size: 12px;line-height: 14px;">
      Dpboss MAIN SRIDEVI panel chart, MAIN SRIDEVI panel chart, old MAIN SRIDEVI panel chart, 
MAIN SRIDEVI pana patti chart, dpboss MAIN SRIDEVI, MAIN SRIDEVI panel record, MAIN SRIDEVI panel record, MAIN SRIDEVI panel chart 2015, 
