...
writing-mode: vertical-rl;
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p>
    Our Maharani Day Panel Chart Records are meticulously compiled, offering users the latest and most precise information crucial for strategic gameplay in the realm of Satta Matka. Whether you're a seasoned player or a newcomer, our charts serve as an invaluable tool for making well-informed decisions and navigating the dynamic landscape of the game. DPBoss Services prioritizes real-time updates, ensuring users have access to accurate data to enhance their Satta Matka experience.
   </p>
   <br/>
