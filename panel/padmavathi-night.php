 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p>
    ...
    DPBoss Services takes pride in the accuracy of its PADMAVATHI Night Panel Chart Records. We employ advanced algorithms and data verification processes to ensure that our charts are dependable and trustworthy.
   </p>
   <p>
    <b>
