...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. Can I play Teen Patti on DPBoss Services hassle-free?
   </p>
   <p class="faq-ans">
    DPBoss Services is known for iys user-friendly gaming interface, allowing players to load their game quickly and navigate it effortlessly.
   </p>
   <p class="faq-title">
    Q2. Does DPBoss Services have automatic advertisements?
   </p>
   <p class="faq-ans">
