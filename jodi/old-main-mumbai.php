...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. Why DPBoss Services should be my website to play my Old Main Mumbai?
   </p>
   <p class="faq-ans">
    DPBoss is famous globally for its wide online Satta game variety, healthy security measures, and dedication to fair play and accountable gambling.
   </p>
   <p class="faq-title">
    Q2. What currencies does DPBoss Services accept?
   </p>
   <p class="faq-ans">
    DPBoss accepts an extensive variety of currencies and offers several international payment methods. The betting platform of the site is approved and controlled by the government.
   </p>
  </div>
  <br/>
  <br/>
