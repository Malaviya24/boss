...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q2. Can I get game support while playing Main Bazar Day on DPBoss Services?
   </p>
   <p class="faq-ans">
