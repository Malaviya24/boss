 ...
 <body>
  ...
  <div class="para3">
   <p style="margin: 0;font-size: 12px;line-height: 14px;">
    ...
    <br/>
    <br/>
    So, if you are curious about it, you can come here and start from scratch you can see some numbers are winning they can be repeating numbers as well you need to pick them out from this big chart and whoever does this enhances their chance of winning their next game so if you want to enhance your chances you need to come here and spend time on this chart and take out useful numbers from this chart if you do it successfully then definitely you will have more chances of winning than your competitors.
    <br/>
    <br/>
    I hope you will see this chart you will come here and try to pick out some winning combinations of the Jodi and will use those Jodi as your next bet and hopefully, you will win the biggest money.
   </p>
  </div>
  <center>
   <div id="bottom">
