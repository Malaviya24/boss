...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. Can I have a hassle-free game experience while playing Super Time on DPBoss Services?
   </p>
   <p class="faq-ans">
    DPBoss Services is celebrated for upholding a user-friendly game interface, enabling players to have a relaxing gaming experience.
   </p>
   <p class="faq-title">
    Q2. What device should I use to play Super Time on DPBoss Services?
   </p>
   <p class="faq-ans">
