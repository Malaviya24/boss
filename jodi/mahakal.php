...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p>
    DPBoss Services always aims to provide its users with the safest as well as the most exciting gaming
   ...
   <p class="faq-title">
    Q1. What does DPBoss Services emphasize players while playing Mahakal on it?
   </p>
   <p class="faq-ans">
    When you choose DPBoss Services to play your Mahakal betting game online, you will be highly
         encouraged to have a sage and responsible gambling experience.
   </p>
   <p class="faq-title">
    Q2. How can I play Mahakal on DPBoss Services responsible?
   </p>
   <p class="faq-ans">
    DPBoss Services suggests all gamblers like you remain in control by setting a betting budget,
