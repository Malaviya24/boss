...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. How often are CB Jodi charts updated on DPBoss Services?
   </p>
   <p class="faq-ans">
    We prioritize your success! DPBoss Services updates CB Jodi charts after every draw, ensuring you have access to the freshest data and the most up-to-date predictions.
   </p>
   <p class="faq-title">
