...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q2. Can I get game support while playing Janta Morning on DPBoss Services?
   </p>
   <p class="faq-ans">
    The customer support section of DPBoss Services has a well-organized team to help novice as well as veteran gamblers in all aspects.
   </p>
  </div>
  <br/>
  <br/>
