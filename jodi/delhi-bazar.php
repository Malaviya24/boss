   ...
   <div>
    <div class="panel panel-info">
     ...
     <div class="jd-chart-div">
      ...
      <p class="jd-chart-p">
       Hello everyone, how are you all? Welcome to dpboss.com. Today we are here to introduce you to a very newly added and fast-growing chart which is the DELHI BAZAR Jodi Chart. This is different from the Goa Chart, this is the DELHI BAZAR Chart.
      </p>
      <p class="jd-chart-p">
       This is another chart from the Jodi group and dpboss.com is here to provide you with the latest results of this market and for the games which are played on this board all day and night.
      </p>
      <p class="jd-chart-p">
