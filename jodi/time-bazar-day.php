...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. Can I play Time Baza Day efficiently on DPBoss Services?
   </p>
   <p class="faq-ans">
   ...
   <p class="faq-title">
    Q2. Is DPBoss Services has consumer forums?
   </p>
   <p class="faq-ans">
    DPBoss Services always aims to offer a hassle-free games experience, so it features an efficient consumer forum, where you can discuss things about your games.
   </p>
  </div>
  <br/>
  <br/>
