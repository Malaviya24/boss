...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. Why should I play Kuber on DPBoss Services?
   </p>
   <p class="faq-ans">
    The key drivers of the Satta Matka website can help you play the game responsibly and safely.
   </p>
   <p class="faq-title">
    Q2. What is the principal aim of DPBoss Services?
   </p>
   <p class="faq-ans">
  ...
  <div class="para3">
   <p style="margin: 0;font-size: 12px;line-height: 14px;">
    Hello everyone, I welcome you to our website Dpboss Services, today, in our chart explainer series, we will pick up another very important and useful chart and this is the Karnataka Day Jodi Chart. As you can guess by the name, it's from the Karnataka market and it's for the games which are played in the daytime and it's a Jodi Chart, even if it's not mentioned in the name. You can identify it by the numbers which are in the Jodi form.
    <br/>
    <br/>
