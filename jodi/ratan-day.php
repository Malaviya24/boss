...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. On what devices can I play the Ratan Day game with DPBoss Services?
   </p>
   <p class="faq-ans">
    You can play Ratan Day on different devices on DPBoss Services, including desktops, laptops, and mobile phones.
   </p>
   <p class="faq-title">
    Q2. What is the speciality of playing Ratan Day on DPBoss Services?
   </p>
   <p class="faq-ans">
    While playing Ratan Day or other Satta Matka games on DPBoss Services, you will be completely immersed in the game because of the website’s exclusive features.
   </p>
  </div>
  <br/>
  <br/>
