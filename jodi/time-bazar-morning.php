...
.faq-heading {
 ...
 <body>
  ...
  <div class="container-fluid footer-text-div">
   ...
   <p class="faq-title">
    Q1. How DPBoss Services can help me play Time Bazar Morning?
   </p>
   <p class="faq-ans">
    DPBoss Services features a guesswork forum and charts results, which will be quite handy for you to analyze and select the meticulous numbers while playing Time Bazar Morning.
   </p>
   <p class="faq-title">
    Q2. What should In need when playing Time Bazar Morning?
   </p>
   <p class="faq-ans">
    DPBoss Services emphasizes all players, including those playing Time Bazar Morning dedicate themselves to the game and the determination to win it.
   </p>
  </div>
  <br/>
  <br/>
